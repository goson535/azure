	...
	*/
    ...
    <div class="flex">
        <div class="casino-page">
                    ...
                    <div class="info">
                        <div class="flex">
                            <div>
                                ...
                                <div class="name">
                                    <span>№<?php echo get_casino_position( get_the_ID() ); ?> <?php echo __( 'in casino rating', 'jgambling' ); ?> </span><br/>
                                    <h1><?php echo $h1; ?></h1>
                                </div>
                            </div>
                            <a href="<?php echo $ref; ?>" rel="nofollow" target="_blank" class="play">
								<?php
								if ( ! $ref_text ) {
									echo __( 'Play', 'jgambling' ) . ' ' . get_the_title();
								} else {
									echo $ref_text;
								} ?>
                            </a>
            ...
            <div class="flex">
                <div class="left-col">
					<?php if ( carbon_get_theme_option( 'show_bonuses_on_casino_review' ) ): ?>
						<?php get_template_part( 'parts/casino-integrated-bonuses' ); ?>
					<?php endif; ?>
					<?php if ( $no_deposit ): ?>
                        <div class="bonus">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo $no_deposit_ref; ?>" class="get custom_color" rel="nofollow"
					...
					<?php if ( $freespins ): ?>
                        <div class="bonus">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo $freespins_ref; ?>" class="get custom_color" rel="nofollow"
                                   target="_blank"><?php echo __( 'Get bonus', 'jgambling' ); ?></a>
                            </div>
                        </div>
					<?php endif; ?>
					...
					<?php if ( $welcome ): ?>
                        <div class="bonus">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo $welcome_ref; ?>" class="get custom_color" rel="nofollow"
                                   target="_blank"><?php echo __( 'Get bonus', 'jgambling' ); ?></a>
                            </div>
                        </div>
					<?php endif; ?>
					<?php if ( $reload ): ?>
                        <div class="bonus">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo $reload_ref; ?>" class="get custom_color" rel="nofollow"
                                   target="_blank"><?php echo __( 'Get bonus', 'jgambling' ); ?></a>
                            </div>
                        </div>
					<?php endif; ?>
					<?php if ( $cashback ): ?>
                        <div class="bonus">
                            ...
                            <div class="content">
                                ...
                                <a href="<?php echo $cashback_ref; ?>" class="get custom_color" rel="nofollow"
                                   target="_blank"><?php echo __( 'Get bonus', 'jgambling' ); ?></a>
                            </div>
                        </div>
					<?php endif; ?>
                ...
                <div class="right-col">
					...
					<?php
					wp_reset_query();
					if ( ! carbon_get_theme_option( 'hide_reviews_and_form' ) ) {
